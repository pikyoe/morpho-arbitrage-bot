...
const router = new Contract(ADDRESSES.AERODROME_ROUTER, AERODROME_ROUTER_ABI, provider);
export async function quote(amountIn, tokenIn, tokenOut, stable = DEFAULT_STABLE) {
    const route = [{
            from: tokenIn,
            to: tokenOut,
            stable,
