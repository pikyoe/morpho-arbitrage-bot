...
async function main() {
  ...
  const adapterBefore: any = await ethers.getContractAt("AerodromeAdapterV2", adapterAddress);
  ...
  try {
    const adapterAfter: any = await ethers.getContractAt("AerodromeAdapterV2", adapterAddress);
