...
describe("V2 safeguards", function () {
  it("pauses the engine and blocks arbitrage execution", async function () {
    ...
    const engine = await ethers.deployContract("ArbitrageEngineV2", [owner.address, owner.address, owner.address, "0x0000000000000000000000000000000000000001", "0x0000000000000000000000000000000000000001"]);
